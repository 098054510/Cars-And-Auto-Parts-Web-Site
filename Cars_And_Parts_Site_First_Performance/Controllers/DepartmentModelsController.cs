...
namespace Cars_And_Parts_Site_First_Performance.Controllers
{
    ...
    {
        private readonly Cars_And_Parts_Site_First_PerformanceContext _context;

        public DepartmentModelsController(Cars_And_Parts_Site_First_PerformanceContext context)
        {
            _context = context;
        }
